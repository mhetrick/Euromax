...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 599.5, 178.0, 25.0, 25.0 ]
								}

							}
, 							{
								"box" : 								{
									"comment" : "Pulse Timing",
									"id" : "obj-41",
									"maxclass" : "inlet",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 528.5, 178.0, 25.0, 25.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 296.0, 74.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 256.0, 185.0, 72.0, 18.0 ],
													"presentation" : 1,
													"presentation_rect" : [ 241.5, 24.5, 72.0, 18.0 ],
													"text" : "pulse width"
												}
...
, 											{
												"box" : 												{
													...
													"parameter_enable" : 0,
													"patching_rect" : [ 206.0, 185.0, 50.0, 18.0 ],
													"presentation" : 1,
													"presentation_rect" : [ 191.5, 24.5, 50.0, 18.0 ]
												}

											}
, 											{
												"box" : 												{
													"comment" : "Init Gliss Freq",
													"id" : "obj-2",
													"maxclass" : "inlet",
													"numinlets" : 0,
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 59.0, 65.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 131.0, 65.0, 125.0, 18.0 ],
													"presentation" : 1,
													"presentation_rect" : [ 97.5, 5.0, 129.0, 18.0 ],
													"text" : "pulse wave generator"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 115.0, 139.0, 125.0, 18.0 ],
													"presentation" : 1,
													"presentation_rect" : [ 60.5, 24.5, 142.0, 18.0 ],
													"text" : "impulse timing (in ms)"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "float", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 59.0, 139.0, 50.0, 18.0 ],
													"presentation" : 1,
													"presentation_rect" : [ 4.5, 24.5, 50.0, 18.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 115.0, 275.0, 46.0, 18.0 ],
													"text" : "train~"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 115.0, 307.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 460.0, 336.0, 298.0, 79.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 3.75, 167.0, 310.5, 49.0 ]
								}
...
,
									"patching_rect" : [ 110.0, 318.0, 311.5, 134.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 38.5, 178.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "trainlet generator"
								}

							}
, 							{
								"box" : 								{
									"comment" : "Trainlet Out",
									"id" : "obj-2",
									"maxclass" : "outlet",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 409.0, 595.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 38.5, 218.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 409.0, 490.0, 32.5, 18.0 ],
									"text" : "*~"
								}
...
,
					"patching_rect" : [ 3.0, 3.0, 319.0, 223.0 ]
				}
